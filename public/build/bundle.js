...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1o2ko35");
    			add_location(h1, file$5, 22, 4, 491);
    			attr_dev(header, "class", "svelte-1o2ko35");
    			add_location(header, file$5, 21, 0, 477);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-p2who1"));
    			attr_dev(button, "type", /*type*/ ctx[0]);
    			add_location(button, file$4, 88, 0, 1543);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*mode*/ 8 && button_class_value !== (button_class_value = "" + (null_to_empty(/*mode*/ ctx[3]) + " svelte-p2who1"))) {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-p2who1");
    			add_location(a, file$4, 86, 0, 1509);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	button2 = new Button({
    			props: { type: "button", caption: "More Details" },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1m4242e");
    			add_location(h1, file$3, 72, 8, 1109);
    			attr_dev(h2, "class", "svelte-1m4242e");
    			add_location(h2, file$3, 73, 8, 1135);
    			attr_dev(p0, "class", "svelte-1m4242e");
    			add_location(p0, file$3, 74, 8, 1163);
    			attr_dev(header, "class", "svelte-1m4242e");
    			add_location(header, file$3, 71, 4, 1091);
    			if (!src_url_equal(img.src, img_src_value = /*imageUrl*/ ctx[2])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", /*title*/ ctx[0]);
    			attr_dev(img, "class", "svelte-1m4242e");
    			add_location(img, file$3, 77, 8, 1230);
    			attr_dev(div0, "class", "image svelte-1m4242e");
    			add_location(div0, file$3, 76, 4, 1201);
    			attr_dev(p1, "class", "svelte-1m4242e");
    			add_location(p1, file$3, 80, 8, 1317);
    			attr_dev(div1, "class", "content svelte-1m4242e");
    			add_location(div1, file$3, 79, 4, 1286);
    			attr_dev(footer, "class", "svelte-1m4242e");
    			add_location(footer, file$3, 82, 4, 1355);
    			attr_dev(article, "class", "svelte-1m4242e");
    			add_location(article, file$3, 70, 0, 1076);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*address*/ 16) set_data_dev(t2, /*address*/ ctx[4]);
    			if (!current || dirty & /*subtitle*/ 2) set_data_dev(t4, /*subtitle*/ ctx[1]);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1egxemf");
    			add_location(input, file$1, 47, 4, 896);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(textarea, "class", "svelte-1egxemf");
    			add_location(textarea, file$1, 45, 4, 836);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(label_1, "class", "svelte-1egxemf");
    			add_location(label_1, file$1, 43, 4, 759);
    			attr_dev(div, "class", "form-control svelte-1egxemf");
    			add_location(div, file$1, 42, 0, 727);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file, 71, 4, 1754);
    			attr_dev(main, "class", "svelte-1k5t77g");
    			add_location(main, file, 70, 0, 1743);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
